  ...
  <div class="typography-container">
    ...
    <p
      style="font-family: {typography.fontFamily.heading}; font-size: {typography.fontSizes
        .special}; font-weight: {typography.fontWeights.regular};"
    >
      Heading / Special / Regular
    </p>
    <p
      style="font-family: {typography.fontFamily.heading}; font-size: {typography.fontSizes
        .h0}; font-weight: {typography.fontWeights.regular};"
    >
      Heading / H0 / Regular
    </p>
    <h1
    ...
    <h2
      style="font-family: {typography.fontFamily.heading}; font-size: {typography.fontSizes
        .h2}; font-weight: {typography.fontWeights.regular};"
    >
      Heading / H2 / Regular
    </h2>
    <h3
    ...
    <h4
      style="font-family: {typography.fontFamily.body}; font-size: {typography.fontSizes
        .h4}; font-weight: {typography.fontWeights.medium};"
    >
      Heading / H4 / Regular
    </h4>
    <h5
