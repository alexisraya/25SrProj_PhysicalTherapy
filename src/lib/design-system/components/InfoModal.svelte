...
<div class="modal-container">
    ...
    <div class="modal-information">
        ...
        {#if isLocked}
            {#if isGoal}
                <p style="font-family: {typography.fontFamily.body}; font-size: {typography.fontSizes.small}; font-weight: {typography.fontWeights.regular};">Your physical therapist will unlock this when ready.</p>
            {:else}
                <p style="font-family: {typography.fontFamily.body}; font-size: {typography.fontSizes.small}; font-weight: {typography.fontWeights.regular};">Keep completing your program to unlock more achievements!</p>
            {/if}
        {:else}
