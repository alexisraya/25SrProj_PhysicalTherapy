    ...
    {#each characters as character}
        ...
        >
            ...
            <div class="character--name {selectedId === character.id ? 'selected-name' : ''}">
                <p style="font-family: {typography.fontFamily.body}; font-size: {typography.fontSizes.regular}; font-weight: {selectedId === character.id ? typography.fontWeights.bold : typography.fontWeights.medium}; line-height: {typography.lineHeight.expanded}">
                {character.name}
                </p>
            </div>
        </button>
