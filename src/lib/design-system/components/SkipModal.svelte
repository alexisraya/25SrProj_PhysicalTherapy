    ...
    <div class="modal-container">
      <div class="modal-text">
        ...
        <p
          style="font-family: {typography.fontFamily
            .body}; font-size: 1.125rem; font-weight: {typography.fontWeights.medium};"
        >
          Skip this Exercise
        </p>
        <p
        ...
        >
          Let us know how you’d like to handle this skipped exercise
        </p>
      </div>
      <div class="modal-buttons">
        ...
        <Button
          ...
          cta="Mark as too painful to complete"
          onClickFunc={handleTooPainful}
        />
      </div>
    </div>
  </div>
