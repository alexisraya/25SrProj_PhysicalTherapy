...
const goals = [
  ...
  },
  {
    ...
    description:
      'You can sit comfortably for an hour at a time, allowing you to focus on work or enjoy a long meal with friends.',
    month: 1,
    timeframe: '4 weeks',
    unlocked: false
  },
  {
    ...
    description:
      'You can squat down to pick up items like groceries or toys from the floor without discomfort.',
    month: 1,
    timeframe: '4 weeks',
    unlocked: false
  },
  {
    ...
    description:
      'You can stand comfortably for 15 minutes, making it easier to shop for groceries or wait in line.',
    month: 1,
    timeframe: '4 weeks',
    unlocked: false
  },
  ...
  },
  {
    ...
    description:
      'You can walk moderate distances for over 20 minutes without your symptoms increasing.',
    month: 2,
    timeframe: '6 weeks',
    unlocked: false
  },
  ...
  // Month 3
  {
    ...
    description:
      'You can go for a light jog or run without experiencing knee pain or swelling afterwards.',
    month: 3,
    timeframe: '12 weeks',
    unlocked: false
  },
  ...
  // Month 6
  {
    ...
    description:
      'You can clear small hurdles or obstacles, demonstrating improved knee strength and stability.',
    month: 6,
    timeframe: '22 weeks',
    unlocked: false
  }
